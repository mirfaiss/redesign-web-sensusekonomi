...
<div class="container my-5">
                            ...
                            <tbody>
                                <tr data-key="6">
                                    ...
                                    <td style="min-width:160px; text-align: center;">
                                        <a class="btn btn-sm btn-primary" href="/topik/tabular/sp2020/5/1/0" data-pjax="0"> Lihat Data <i class="bi bi-arrow-right" style="font-weight: bold;"></i></a>
                                    </td>
                                </tr>
                                <tr data-key="5">
                                    ...
                                    <td style="min-width:160px; text-align: center;">
                                        <a class="btn btn-sm btn-primary" href="/topik/tabular/sp2020/4/1/0" data-pjax="0"> Lihat Data <i class="bi bi-arrow-right"></i></a>
                                    </td>
                                </tr>
                                <tr data-key="4">
                                    ...
                                    <td style="min-width:160px; text-align: center;">
                                        <a class="btn btn-sm btn-primary" href="/topik/tabular/sp2020/3/1/0" data-pjax="0"> Lihat Data <i class="bi bi-arrow-right"></i></a>
                                    </td>
                                </tr>
                                <tr data-key="3">
                                    ...
                                    <td style="min-width:160px; text-align: center;">
                                        <a class="btn btn-sm btn-primary" href="/topik/tabular/sp2020/2/1/0" data-pjax="0"> Lihat Data <i class="bi bi-arrow-right"></i></a>
                                    </td>
                                </tr>
                                <tr data-key="2">
                                    ...
                                    <td style="min-width:160px; text-align: center;">
                                        <a class="btn btn-sm btn-primary" href="/topik/tabular/sp2020/1/1/0" data-pjax="0"> Lihat Data <i class="bi bi-arrow-right"></i></a>
                                    </td>
                                </tr>
                                <tr data-key="1">
    ...
    <section class="py-5">
        <div class="container">
            <h4 class="text-center">Telusuri Data Berdasarkan Tabel Topik</h4>
