    ...
    <div class="row">
      <div class="col-md-7 rounded-pill d-none d-md-flex align-items-center bg-lightorange2 justify-content-between">
        <a class="text-decoration-none text-darkbrown" style="font-weight: 900;" href="#">
          <img src="/assets/images/logo-bps.svg" alt="Logo-BPS" style="max-width: 18%; padding: 6px;" class="d-inline-block align-text-center">
          <i>
  ...
  <div class="container-md">
    ...
    <div class="collapse navbar-collapse nav-custom" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-1">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/se2016-lanjutan/pendataan-umk-umb">SE2016 LANJUTAN</a>
        </li>
