 ...
 *   https://datatables.net/download/#bs4/dt-1.10.23/b-1.6.5/b-html5-1.6.5/fh-3.1.7/r-2.2.6
 *
 * Included libraries:
 *   DataTables 1.10.23, Buttons 1.6.5, HTML5 export 1.6.5, FixedHeader 3.1.7, Responsive 2.2.6
 */
...
(function(k) {
    ...
    u.ext = L = {
        buttons: {},
        classes: {},
        build: "bs4/dt-1.10.23/b-1.6.5/b-html5-1.6.5/fh-3.1.7/r-2.2.6",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
...
(function(e) {
    ...
    function E(a, b, c) {
        e.fn.animate ? a.stop().fadeIn(b, c) : (a.css("display", "block"),
        c && c.call(a))
    }
    function F(a, b, c) {
        e.fn.animate ? a.stop().fadeOut(b, c) : (a.css("display", "none"),
        c && c.call(a))
    }
    function H(a, b) {
        a = new t.Api(a);
    ...
    e.extend(w.prototype, {
        ...
        _expandButton: function(a, b, c, d) {
            ...
            for (var k = 0, g = b.length; k < g; k++) {
                ...
                if (m)
                    if (Array.isArray(m))
                        this._expandButton(a, m, c, d);
                    else {
                        var l = this._buildButton(m, c);
                        l && (d !== u && null !== d ? (a.splice(d, 0, l),
                        d++) : a.push(l),
                        l.conf.buttons && (l.collection = e("<" + this.c.dom.collection.tag + "/>"),
        ...
        _buildButton: function(a, b) {
            ...
            var m = a.clickBlurs === u ? !0 : a.clickBlurs
              , l = e("<" + h + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(n) {
                n.preventDefault();
            ...
            d.tag ? (h = e("<" + d.tag + "/>").html(k(a.text)).addClass(d.className),
            "a" === d.tag.toLowerCase() && h.attr("href", "#"),
            l.append(h)) : l.html(k(a.text));
            ...
            if (!b._buttonsHandled) {
                var c = function(d) {
                    for (var h = 0, f = d.length; h < f; h++) {
                        ...
                        e(g).click()) : !e.isPlainObject(k.key) || k.key.key !== a || k.key.shiftKey && !b.shiftKey || k.key.altKey && !b.altKey || k.key.ctrlKey && !b.ctrlKey || k.key.metaKey && !b.metaKey || (b._buttonsHandled = !0,
                        e(g).click()));
        ...
        _popover: function(a, b, c) {
            ...
            "dt-container" === h.align && (f = f.parent(),
            c.css("width", d.width()));
            if ("absolute" === g && (c.hasClass(h.rightAlignClassName) || c.hasClass(h.leftAlignClassName) || "dt-container" === h.align)) {
                ...
                B = r + B;
                r = 0;
                c.hasClass(h.rightAlignClassName) ? (r = B - q,
                m > g + r && (g = m - (g + r),
                d -= q + r,
                r = g > d ? r + d : r + g)) : (r = m - g,
                d < q + r && (g = m - (g + r),
                ...
                c.css("left", c.position().left + r)) : (g = c.height() / 2,
        ...
        var c = []
          ...
          , h = function(f) {
            if (Array.isArray(f))
                ...
                "string" === typeof f ? -1 !== f.indexOf(",") ? h(f.split(",")) : (f = e.inArray(f.trim(), d),
                -1 !== f && c.push(b[f].inst)) : "number" === typeof f && c.push(b[f].inst)
        };
        h(a);
        return c
    }
    ...
    w.buttonSelector = function(a, b) {
        for (var c = [], d = function(g, m, l) {
            ...
            if (Array.isArray(g) || g instanceof e)
                ...
                "object" === typeof g && g.nodeName && (n = e.inArray(g, p),
                -1 !== n && c.push({
                    inst: m,
                    node: p[n]
                }))
    ...
    e.extend(x, {
        ...
        copy: function(a, b) {
            if (x.copyHtml5)
                return "copyHtml5";
            if (x.copyFlash && x.copyFlash.available(a, b))
                return "copyFlash"
        },
        csv: function(a, b) {
            if (x.csvHtml5 && x.csvHtml5.available(a, b))
                return "csvHtml5";
            if (x.csvFlash && x.csvFlash.available(a, b))
                return "csvFlash"
        },
        excel: function(a, b) {
        ...
        pdf: function(a, b) {
            if (x.pdfHtml5 && x.pdfHtml5.available(a, b))
                return "pdfHtml5";
            if (x.pdfFlash && x.pdfFlash.available(a, b))
                return "pdfFlash"
        },
    ...
    t.Api.register("button().add()", function(a, b) {
        var c = this.context;
        c.length && (c = w.instanceSelector(this._groupSelector, c[0]._buttons),
    ...
    t.Api.register("buttons.info()", function(a, b, c) {
        ...
        a = a ? "<h2>" + a + "</h2>" : "";
        E(e('<div id="datatables_buttons_info" class="dt-button-info"/>').html(a).append(e("<div/>")["string" === typeof b ? "html" : "append"](b)).css("display", "none").appendTo("body"));
    ...
    t.Api.register("buttons.exportData()", function(a) {
        if (this.context.length)
            return P(new t.Api(this.context[0]), a)
    });
    t.Api.register("buttons.exportInfo()", function(a) {
        ...
        c === u || null === c ? c = null : (-1 !== c.indexOf("*") && (c = c.replace("*", e("head > title").text()).trim()),
      ...
      , P = function(a, b) {
        var c = e.extend(!0, {}, {
          ...
          , d = function(q) {
            ...
            c.decodeEntities && (L.innerHTML = q,
            q = L.value);
            return q
        };
...
(function(c) {
    ...
    c.extend(l.prototype, {
        ...
        headerOffset: function(a) {
            a !== h && (this.c.headerOffset = a,
            this.update());
            return this.c.headerOffset
        },
        footerOffset: function(a) {
            a !== h && (this.c.footerOffset = a,
            this.update());
        ...
        _constructor: function() {
            var a = this
              , b = this.s.dt;
            c(d).on("scroll" + this.s.namespace, function() {
                a._scroll()
        ...
        _clone: function(a, b) {
            ...
            !b && e.floating ? e.floating.removeClass("fixedHeader-floating fixedHeader-locked") : (e.floating && (e.placeholder.remove(),
            this._unsize(a),
        ...
        _horizontal: function(a, b) {
            var c = this.dom[a]
              , e = this.s.position
              , f = this.s.scrollLeft;
            c.floating && f[a] !== b && (c.floating.css("left", e.left - b),
            f[a] = b)
        },
        _modeChange: function(a, b, k) {
            ...
            l && l.blur();
            "in-place" === a ? (e.placeholder && (e.placeholder.remove(),
            e.placeholder = null),
            this._unsize(b),
            "header" === b ? e.host.prepend(h) : e.host.append(h),
            e.floating && (e.floating.remove(),
            e.floating = null)) : "in" === a ? (this._clone(b, k),
            e.floating.addClass("fixedHeader-floating").css("header" === b ? "top" : "bottom", this.c[b + "Offset"]).css("left", d.left + "px"),
            g(d.width),
            "footer" === b && e.floating.css("top", "")) : "below" === a ? (this._clone(b, k),
            e.floating.addClass("fixedHeader-locked").css("top", d.tfootTop - d.theadHeight).css("left", d.left + "px"),
            g(d.width)) : "above" === a && (this._clone(b, k),
            e.floating.addClass("fixedHeader-locked").css("top", d.tbodyTop).css("left", d.left + "px"),
            g(d.width));
        ...
        _positions: function() {
            ...
            d.length ? (b.tfootTop = d.offset().top,
            b.tfootBottom = b.tfootTop + d.outerHeight(),
            b.tfootHeight = b.tfootBottom - b.tfootTop) : (b.tfootTop = b.tbodyTop + f.outerHeight(),
        ...
        _scroll: function(a) {
            ...
            this.c.footer && this.dom.tfoot.length && (b = this.s.enable ? !e.visible || b + e.windowHeight >= e.tfootBottom + this.c.footerOffset ? "in-place" : e.windowHeight + b > e.tbodyTop + e.tfootHeight + this.c.footerOffset ? "in" : "above" : "in-place",
    ...
    c(f).on("init.dt.dtfh", function(a, b, d) {
        "dt" === a.namespace && (a = b.oInit.fixedHeader,
        d = g.defaults.fixedHeader,
        !a && !d || b._fixedHeader || (d = c.extend({}, d, a),
        !1 !== a && new l(b,d)))
    });
